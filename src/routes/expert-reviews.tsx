  ...
  <div className="max-w-6xl mx-auto">
    <div className="text-center mb-12">
      <p className="text-sm font-semibold text-blue-600 uppercase tracking-wide">
        Aanbevolen door herstelexperts
      </p>
      <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mt-3">
        Advies van gecertificeerde professionals
      </h2>
      <p className="text-gray-600 mt-4 max-w-2xl mx-auto">
        Experts benadrukken het belang van structuur, veilige opbouw en duidelijke begeleiding tijdens knieherstel.
      </p>
    </div>
    ...
    <div className="grid md:grid-cols-3 gap-6">
      <div className="rounded-2xl border border-gray-200 p-6 shadow-sm bg-gray-50">
        <p className="text-gray-700">
          “Een gestructureerde revalidatie-app kan voetballers helpen om hun herstel beter te volgen en bewuster met oefeningen om te gaan.”
        </p>
        <div className="mt-5">
          <p className="font-semibold text-gray-900">Gecertificeerd fysiotherapeut</p>
          <p className="text-sm text-gray-500">Sportrevalidatie</p>
        </div>
      </div>

      <div className="rounded-2xl border border-gray-200 p-6 shadow-sm bg-gray-50">
        <p className="text-gray-700">
          “Voor voetballers met een knieblessure is duidelijke begeleiding belangrijk. Jouw VoetbalKnie maakt de herstelstappen overzichtelijk.”
        </p>
        <div className="mt-5">
          <p className="font-semibold text-gray-900">Herstelexpert</p>
          <p className="text-sm text-gray-500">Blessurepreventie en herstel</p>
        </div>
      </div>

      <div className="rounded-2xl border border-gray-200 p-6 shadow-sm bg-gray-50">
        <p className="text-gray-700">
          “De combinatie van uitleg, voortgang en oefenstructuur kan bijdragen aan meer vertrouwen tijdens het herstelproces.”
        </p>
        <div className="mt-5">
          <p className="font-semibold text-gray-900">Sportfysiotherapeut</p>
          <p className="text-sm text-gray-500">Knie- en sportblessures</p>
        </div>
      </div>
    </div>
  </div>
    ...
    <header className="sticky top-0 z-40 w-full border-b border-border/60 bg-background/80 backdrop-blur-xl">
      <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-6">
        ...
        <nav className="hidden items-center gap-8 text-sm font-medium text-muted-foreground md:flex">
          ...
          <a href="/app-in-ontwikkeling-expertreviews" className="transition-colors hover:text-foreground">Download</a>
        </nav>
        <a
          href="/app-in-ontwikkeling-expertreviews"
        ...
        <section className="py-20 px-6 bg-white border-b border-border">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <h2 className="text-4xl md:text-5xl font-black text-foreground mt-3 uppercase">
                Advies van gecertificeerde professionals
              </h2>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="rounded-2xl border border-border p-6 shadow-sm bg-muted/30">
                <p className="text-muted-foreground">
                  “Een gestructureerde revalidatie-app kan voetballers helpen om hun herstel beter te volgen en bewuster met oefeningen om te gaan.”
                </p>
                <div className="mt-5">
                  <p className="font-bold text-foreground">Gecertificeerd fysiotherapeut</p>
                  <p className="text-sm text-muted-foreground">Sportrevalidatie</p>
                </div>
              </div>
              ...
              <div className="rounded-2xl border border-border p-6 shadow-sm bg-muted/30">
                ...
                <div className="mt-5">
                  <p className="font-bold text-foreground">Herstelexpert</p>
                  <p className="text-sm text-muted-foreground">Blessurepreventie en herstel</p>
                </div>
              </div>
              ...
              <div className="rounded-2xl border border-border p-6 shadow-sm bg-muted/30">
                ...
                <div className="mt-5">
                  <p className="font-bold text-foreground">Sportfysiotherapeut</p>
                  <p className="text-sm text-muted-foreground">Knie- en sportblessures</p>
                </div>
              </div>
            </div>
          </div>
