  ...
  <div className="max-w-6xl mx-auto">
    <div className="text-center mb-12">
      ...
      <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mt-3">
        Voetballers die Jouw VoetbalKnie al gebruikten
      </h2>
      <p className="text-gray-600 mt-4 max-w-2xl mx-auto">
        Lees hoe andere voetballers met een knieblessure meer vertrouwen kregen in hun herstel.
      </p>
    </div>
    ...
    <div className="grid md:grid-cols-3 gap-6">
      <div className="rounded-2xl border border-gray-200 p-6 shadow-sm bg-gray-50">
        <p className="text-gray-700">
          “Door Jouw VoetbalKnie wist ik eindelijk welke oefeningen ik veilig kon doen zonder mijn knie te overbelasten.”
        </p>
        <div className="mt-5">
          <p className="font-semibold text-gray-900">Tom, 22 jaar</p>
          <p className="text-sm text-gray-500">Amateurvoetballer</p>
        </div>
      </div>

      <div className="rounded-2xl border border-gray-200 p-6 shadow-sm bg-gray-50">
        <p className="text-gray-700">
          “Ik vond vooral de duidelijke stappen fijn. Het voelde alsof ik meer grip had op mijn revalidatie.”
        </p>
        <div className="mt-5">
          <p className="font-semibold text-gray-900">Milan, 19 jaar</p>
          <p className="text-sm text-gray-500">Voetballer na knieblessure</p>
        </div>
      </div>

      <div className="rounded-2xl border border-gray-200 p-6 shadow-sm bg-gray-50">
        <p className="text-gray-700">
          “De app hielp mij om gemotiveerd te blijven, omdat ik precies kon zien wat de volgende stap was.”
        </p>
        <div className="mt-5">
          <p className="font-semibold text-gray-900">Sam, 25 jaar</p>
          <p className="text-sm text-gray-500">Recreatief voetballer</p>
        </div>
      </div>
    </div>
  </div>
    ...
    <header className="sticky top-0 z-40 w-full border-b border-border/60 bg-background/80 backdrop-blur-xl">
      <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-6">
        ...
        <nav className="hidden items-center gap-8 text-sm font-medium text-muted-foreground md:flex">
          ...
          <a href="/app-in-ontwikkeling?variant=gebruikersreviews" className="transition-colors hover:text-foreground">Download</a>
        </nav>
        <a
          href="/app-in-ontwikkeling?variant=gebruikersreviews"
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="rounded-2xl border border-border p-6 shadow-sm bg-muted/30">
                ...
                <div className="mt-5">
                  <p className="font-bold text-foreground">Tom, 22 jaar</p>
                  <p className="text-sm text-muted-foreground">Amateurvoetballer</p>
                </div>
              </div>
              ...
              <div className="rounded-2xl border border-border p-6 shadow-sm bg-muted/30">
                ...
                <div className="mt-5">
                  <p className="font-bold text-foreground">Milan, 19 jaar</p>
                  <p className="text-sm text-muted-foreground">Voetballer na knieblessure</p>
                </div>
              </div>
              ...
              <div className="rounded-2xl border border-border p-6 shadow-sm bg-muted/30">
                ...
                <div className="mt-5">
                  <p className="font-bold text-foreground">Sam, 25 jaar</p>
                  <p className="text-sm text-muted-foreground">Recreatief voetballer</p>
                </div>
              </div>
            </div>
          </div>
